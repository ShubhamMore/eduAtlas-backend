...
let AddOnlineClassComponent = class AddOnlineClassComponent {
    ...
    getMeeting(id) {
        this.api.getOneMeeting({ id }).subscribe((data) => {
            this.meeting = data;
    ...
    saveOnlineClass() {
        if (this.onlineClassForm.valid) {
            ...
            if (!this.edit) {
                ...
                this.api.updateMeeting(onlineClass).subscribe((res) => {
...
AddOnlineClassComponent.ctorParameters = () => [
...
AddOnlineClassComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_6__["Component"])({
        selector: 'ngx-add-online-class',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./add-online-class.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/institute/online-classes/online-classes-conf/add-online-class/add-online-class.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./add-online-class.component.scss */ "./src/app/pages/institute/online-classes/online-classes-conf/add-online-class/add-online-class.component.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"],
        ...
        _nebular_theme__WEBPACK_IMPORTED_MODULE_2__["NbToastrService"]])
...
let ManageOnlineClassComponent = class ManageOnlineClassComponent {
    constructor(active, api, router, route) {
        this.active = active;
        this.api = api;
        this.router = router;
        this.route = route;
    ...
    deleteMeeting(id, meetingId) {
        this.api.deleteMeeting({ _id: id, meetingId: meetingId }).subscribe((res) => { }, (err) => { });
    }
    createTime(time) {
...
ManageOnlineClassComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
ManageOnlineClassComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'ngx-manage-online-class',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./manage-online-class.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/institute/online-classes/online-classes-conf/manage-online-class/manage-online-class.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./manage-online-class.component.scss */ "./src/app/pages/institute/online-classes/online-classes-conf/manage-online-class/manage-online-class.component.scss")).default]
    }),
...
let OnlineClassSettingsComponent = class OnlineClassSettingsComponent {
    constructor(fb, api, route, toasterService, authService, router) {
        this.fb = fb;
        this.api = api;
        this.route = route;
        this.toasterService = toasterService;
    ...
    onSubmit() {
        ...
        this.api.addCredentials(requestData).subscribe((res) => {
            this.showToast('top-right', 'success', 'Settings Updated');
            this.api.getZoomAuth({ userId: res.user_id }).subscribe((data) => {
...
OnlineClassSettingsComponent.ctorParameters = () => [
...
OnlineClassSettingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'ngx-online-class-settings',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./online-class-settings.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/institute/online-classes/online-classes-conf/online-class-settings/online-class-settings.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./online-class-settings.component.scss */ "./src/app/pages/institute/online-classes/online-classes-conf/online-class-settings/online-class-settings.component.scss")).default]
    }),
...
let OnlineClassesConfComponent = class OnlineClassesConfComponent {
    constructor() { }
    ngOnInit() { }
};
OnlineClassesConfComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'ngx-branch-conf',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./online-classes-conf.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/institute/online-classes/online-classes-conf/online-classes-conf.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./online-classes-conf.component.scss */ "./src/app/pages/institute/online-classes/online-classes-conf/online-classes-conf.component.scss")).default]
    }),
...
/* harmony import */ var _online_classes_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./online-classes-routing.module */ "./src/app/pages/institute/online-classes/online-classes-routing.module.ts");
...
/* harmony import */ var _online_classes_conf_add_online_class_add_online_class_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./online-classes-conf/add-online-class/add-online-class.component */ "./src/app/pages/institute/online-classes/online-classes-conf/add-online-class/add-online-class.component.ts");
...
let OnlineClassesModule = class OnlineClassesModule {
};
OnlineClassesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _online_classes_conf_online_classes_conf_component__WEBPACK_IMPORTED_MODULE_10__["OnlineClassesConfComponent"],
        ...
        imports: [
            ...
            _online_classes_routing_module__WEBPACK_IMPORTED_MODULE_3__["OnlineClassesRoutingModule"],
            ...
            _nebular_theme__WEBPACK_IMPORTED_MODULE_8__["NbMenuModule"],
...
//# sourceMappingURL=online-classes-online-classes-module-es2015.js.map