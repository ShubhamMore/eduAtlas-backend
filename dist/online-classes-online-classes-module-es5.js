...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["online-classes-online-classes-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesInstituteOnlineClassesOnlineClassesUpgradeOnlineClassesUpgradeComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
      ...
      _createClass(AddOnlineClassComponent, [{
        ...
        value: function getCourses(id) {
          ...
          this.api.getCourseTD(id).subscribe(function (data) {
            ...
            _this3.courses = _this3.institute.course;
  ...
  function srcAppPagesInstituteOnlineClassesOnlineClassesRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _online_classes_upgrade_online_classes_upgrade_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./online-classes-upgrade/online-classes-upgrade.component */
    ...
    var _online_classes_conf_online_classes_conf_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./online-classes-conf/online-classes-conf.component */
    "./src/app/pages/institute/online-classes/online-classes-conf/online-classes-conf.component.ts");
    /* harmony import */


    var _online_classes_conf_add_online_class_add_online_class_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./online-classes-conf/add-online-class/add-online-class.component */
    "./src/app/pages/institute/online-classes/online-classes-conf/add-online-class/add-online-class.component.ts");
    /* harmony import */


    var _online_classes_conf_online_class_settings_online_class_settings_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./online-classes-conf/online-class-settings/online-class-settings.component */
    "./src/app/pages/institute/online-classes/online-classes-conf/online-class-settings/online-class-settings.component.ts");
    /* harmony import */


    var _online_classes_conf_manage_online_class_manage_online_class_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var routes = [{
      ...
      children: [{
        path: 'settings/:id',
        component: _online_classes_conf_online_class_settings_online_class_settings_component__WEBPACK_IMPORTED_MODULE_6__["OnlineClassSettingsComponent"]
      }, {
        path: 'create-class/:id',
        component: _online_classes_conf_add_online_class_add_online_class_component__WEBPACK_IMPORTED_MODULE_5__["AddOnlineClassComponent"]
      }, {
        path: 'create-class/:id/edit',
        component: _online_classes_conf_add_online_class_add_online_class_component__WEBPACK_IMPORTED_MODULE_5__["AddOnlineClassComponent"]
      }, {
        path: 'manage-class/:id',
        component: _online_classes_conf_manage_online_class_manage_online_class_component__WEBPACK_IMPORTED_MODULE_7__["ManageOnlineClassComponent"]
      }, {
        path: ':id',
        component: _online_classes_upgrade_online_classes_upgrade_component__WEBPACK_IMPORTED_MODULE_1__["OnlineClassesUpgradeComponent"]
      }]
    }];
    ...
    OnlineClassesRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
  ...
  /***/
  function srcAppPagesInstituteOnlineClassesOnlineClassesUpgradeOnlineClassesUpgradeComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesInstituteOnlineClassesOnlineClassesUpgradeOnlineClassesUpgradeComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OnlineClassesUpgradeComponent", function () {
    ...
    var OnlineClassesUpgradeComponent = /*#__PURE__*/function () {
      function OnlineClassesUpgradeComponent() {
        _classCallCheck(this, OnlineClassesUpgradeComponent);
      }
    ...
    OnlineClassesUpgradeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'ngx-online-classes-upgrade',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./online-classes-upgrade.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/institute/online-classes/online-classes-upgrade/online-classes-upgrade.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./online-classes-upgrade.component.scss */
      "./src/app/pages/institute/online-classes/online-classes-upgrade/online-classes-upgrade.component.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], OnlineClassesUpgradeComponent);
    /***/
  },
  ...
  function srcAppPagesInstituteOnlineClassesOnlineClassesModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _online_classes_upgrade_online_classes_upgrade_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./online-classes-upgrade/online-classes-upgrade.component */
    "./src/app/pages/institute/online-classes/online-classes-upgrade/online-classes-upgrade.component.ts");
